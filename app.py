...
Ref: {ctx}
JSON: {{"es_correcta":bool, "codigo_sugerido":"str", "justificacion":"str"}}"""
        ...
        # --- CORRECCIÓN: El nombre debe venir del catálogo ---
        ...
        nombre_real = obtener_nombre_desde_catalogo(codigo_sugerido_corregido)
        
        resultado['codigo_sugerido'] = codigo_sugerido_corregido
        resultado['nombre_sugerido'] = nombre_real if nombre_real else nombre_actual
        
        # Si el código coincide, es correcta
        if codigo_sugerido_corregido == codigo_actual:
